...
export default function Header() {
  return (
    <nav className="relative w-fit mx-auto z-10 p-10  flex gap-4">
      ...
      <NavButton route="https://soundcloud.com/biensurr"><Image
      priority
      src={soundcloudIcon}
      alt="Soundcloud"
    /></NavButton>
      <NavButton route="https://www.instagram.com/lex_klein_"><Image
      priority
      src={igIcon}
      alt="Instagram"
    /></NavButton>
      <NavButton route="https://twitter.com/thickassdj"><Image
      priority
      src={twitterIcon}
      alt="Twitter"
    /></NavButton>
